...
sed 's/dev tun/dev '"$VPN_INT"'/g' < /etc/openvpn/client-template.txt > /etc/openvpn/client-template.tmp
mv /etc/openvpn/client-template.tmp /etc/openvpn/client-template.txt
